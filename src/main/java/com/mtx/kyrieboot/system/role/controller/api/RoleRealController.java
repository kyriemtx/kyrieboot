package com.mtx.kyrieboot.system.role.controller.api;
...
import com.mtx.kyrieboot.system.menu.service.SysMenuRoleService;
...
public class RoleRealController {
    ...
    public AjaxResult selectForm(SysRole sysRole){
        ...
        if(sysRole == null){
            IPage<SysRole> sysRoleIPage = sysRoleService.getAll(new Page(1,10));
            sysRoles = sysRoleIPage.getRecords();
        }else {
        ...
        jsonObject.put("sysRoleList",sysRoles);
        return AjaxResult.success(jsonObject);
